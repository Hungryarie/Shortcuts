				...
				<!-- Header -->
					<header id="header">
						<div class="inner">
							...
							<!-- Logo -->
								<a href="/shortcuts" class="logo">
									<span class="symbol"><img src="/images/logo.svg" alt="" /></span><span class="title">Shortcuts</span>
								</a>
				...
				<!-- Footer -->
					<footer id="footer">
						<div class="inner">
                            ...
                            -->
							<ul class="copyright">
								<li>&copy; Arnoud Zwakenberg. All rights reserved</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
							</ul>
						</div>
					</footer>
